...
import static jdk.internal.foreign.PlatformLayouts.PPC64;

import static java.lang.foreign.MemoryLayout.PathElement.groupElement;
import static jdk.internal.foreign.abi.SharedUtils.SimpleVaArg;
import static jdk.internal.foreign.abi.SharedUtils.THROWING_ALLOCATOR;
import static jdk.internal.foreign.abi.ppc64.CallArranger.MAX_REGISTER_ARGUMENTS;
 ...
 */
public non-sealed class LinuxPPC64VaList implements VaList, Scoped {
    ...
    static final GroupLayout LAYOUT = MemoryLayout.structLayout(
        PPC64.C_POINTER.withName("__stack"),
        PPC64.C_POINTER.withName("__gr_top"),
        PPC64.C_POINTER.withName("__vr_top"),
        PPC64.C_INT.withName("__gr_offs"),
        PPC64.C_INT.withName("__vr_offs")
    ).withName("__va_list");
    ...
    private LinuxPPC64VaList(MemorySegment segment, MemorySegment stack,
    ...
    private static LinuxPPC64VaList readFromSegment(MemorySegment segment) {
        ...
        return new LinuxPPC64VaList(segment, stack, gpRegsArea, MAX_GP_OFFSET, fpRegsArea, MAX_FP_OFFSET);
    }
        ...
        if (isRegOverflow(currentGPOffset(), currentFPOffset(), typeClass, layout)) {
            ...
            return switch (typeClass) {
                ...
                case STRUCT_REFERENCE -> {
                    ...
                    VarHandle ptrReader = PPC64.C_POINTER.varHandle();
    ...
    static LinuxPPC64VaList.Builder builder(MemorySession session) {
        return new LinuxPPC64VaList.Builder(session);
    }
    ...
    public VaList copy() {
        ...
        return new LinuxPPC64VaList(copy, stack, gpRegsArea, gpLimit, fpRegsArea, fpLimit);
    }
    ...
    public static non-sealed class Builder implements VaList.Builder {
            ...
            if (isRegOverflow(currentGPOffset, currentFPOffset, typeClass, layout)) {
                ...
                switch (typeClass) {
                    ...
                    case STRUCT_REFERENCE -> {
                        // Struct is passed indirectly via a pointer in an integer register.
                        MemorySegment valueSegment = (MemorySegment) value;
                        VarHandle writer = PPC64.C_POINTER.varHandle();
        ...
        public VaList build() {
            ...
            return new LinuxPPC64VaList(vaListSegment, stackArgsSegment, gpRegs, currentGPOffset, fpRegs, currentFPOffset);
        }
    }
}
